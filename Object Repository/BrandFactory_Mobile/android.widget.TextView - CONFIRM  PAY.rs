...
<MobileElementEntity>
   ...
   <name>android.widget.TextView - CONFIRM  PAY</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'CONFIRM &amp; PAY' or . = 'CONFIRM &amp; PAY')]</locator>
